...
## Updating Version (ThunderPipe.Sdk)
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <PropertyGroup>
    ...
    <AssemblyName>YourAccount.ModName</AssemblyName>
...
This property is used by ThunderPipe.Sdk when it builds your Thunderstore package.
